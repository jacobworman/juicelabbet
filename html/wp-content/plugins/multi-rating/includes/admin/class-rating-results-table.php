		...
		switch( $column_name ) {
			...
			case MR_Rating_Results_Table::POST_ID_COLUMN : {
				...
				<div class="row-actions">
					<span class="id"><?php printf( __( 'ID: %d'),  $temp_post_id ); ?> | </span>
					<?php
			...
			case MR_Rating_Results_Table::RATING_RESULT_COLUMN : {
				...
				?>
				<div class="row-actions">
					<span class="edit"><a href="?page=<?php echo Multi_Rating::RATING_ENTRIES_PAGE_SLUG; ?>&post-id=<?php echo $post_id; ?>"><?php _e( 'View Entries', 'multi-rating' ); ?></a></span>
				</div>
