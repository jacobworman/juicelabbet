		...
		<?php if ( has_post_thumbnail() || $elara_example_content == 1 ) : ?>
			<div class="entry-thumb">
				...
				<?php if ( has_post_thumbnail() ) : ?>
					<?php the_post_thumbnail( null, array( 'alt' => get_the_title(), 'class' => 'img-responsive' ) ); ?>
...
if ( ! function_exists( 'elara_entry_separator' ) ) :
	...
	function elara_entry_separator( $check, $separator = '&#47;' ) {
		...
		if ( $check == 'categories-date' && $show_category && $show_date ) :
			echo $separator;
		elseif ( $check == 'author-comments' && $show_author && ( $show_comments && ! post_password_required() && comments_open() ) ) :
			echo $separator;
		endif;
	}
endif;
